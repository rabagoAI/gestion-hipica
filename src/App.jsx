...
function App() {
  ...
  // Los sacamos fuera para poder usarlos si no hay nada guardado
  ...
  // Función auxiliar para cargar datos o usar los iniciales
  ...
  // --- 2. EFECTOS PARA GUARDAR AUTOMÁTICAMENTE ---
